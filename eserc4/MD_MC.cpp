...
//Print initial values for measured properties
  ...
  cout << "Initial pressure         = " << rho * temp + walker[ipr] << endl;  
...
// distance i-j in pbc
  ...
  walker[iv] = (4.0 * v) /(double)npart; // Potential energy 
  ...
  walker[ipr] = rho * walker[it] + ( 16. * p) / vol;  //Pressure 
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Epot, Ekin, Etot, Temp, Pres;   //aggiunto pressione
   const int wd=12;
