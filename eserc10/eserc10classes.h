#ifndef __eserc10classes__
#define __eserc10classes__
...
class Map {
    ...
    public: 
        ...
        void SetMap(vector< vector<double> > &m){
...
class Genetic {
    ...
    public: 
        ...
        Genetic(Random& r, Map& m, int nindividuals) {
        ...
        void SetIndividual(Path p, int i){
